...
/// [inputSchema] is plain JSON Schema — the same shape every major
/// provider (OpenAI, Anthropic, Gemini) and MCP expect for tool/function
/// parameters — so adapting a [Tool] to any provider's native format is
/// a matter of relabelling fields, not converting schema dialects.
///
/// ```dart
/// final bashTool = Tool(
///   name: 'bash',
