...
/// (truncation). All values have sensible defaults for typical coding
/// tasks.
///
/// ```dart
...
class AgentConfig extends Equatable {
  ...
  /// Timeout for each individual command execution.
  ///
  /// Applies to agents (like [MiniSweAgent]) whose tools shell out to a
  /// sandbox or subprocess. Tools that don't run external commands can
  /// ignore this.
